...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div className="bg-white shadow-[0px_4px_10px_rgba(205,205,205,0.11)] flex w-full max-w-[1348px] items-center gap-5 flex-wrap justify-between px-4 py-3.5 rounded-2xl max-md:max-w-full">
